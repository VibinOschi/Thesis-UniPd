...
Nella tabella \ref{tab:res-obiettivi} si possono vedere i vari stati di completamento dei vari obiettivi che erano stati definiti precedentemente in \ref{tab:obiettivi}.\\
